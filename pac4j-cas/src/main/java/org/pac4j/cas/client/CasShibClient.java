 ...
 * @since 1.4.0
 */
public class CasShibClient extends BaseClient<CasCredentials, CasProfile> {

    protected static final Logger logger = LoggerFactory.getLogger(CasShibClient.class);
    ...
    protected BaseClient<CasCredentials, CasProfile> newClient() {
        final CasShibClient casClient = new CasShibClient();
